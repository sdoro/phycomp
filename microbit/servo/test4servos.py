...
theBoard = KitronikRoboticsBoard           # NB: class no constructor
while True:
    if button_a.is_pressed():
        theBoard.servoWrite(theBoard, 1, angleA)                 # close
        theBoard.servoWrite(theBoard, 2, angleA)
        theBoard.servoWrite(theBoard, 3, angleA)
        theBoard.servoWrite(theBoard, 4, angleA)
    if button_b.is_pressed():
        theBoard.servoWrite(theBoard, 1, angleB)                  # open
        theBoard.servoWrite(theBoard, 2, angleB)
        theBoard.servoWrite(theBoard, 3, angleB)
        theBoard.servoWrite(theBoard, 4, angleB)
    if button_a.is_pressed() and button_b.is_pressed():       # end
